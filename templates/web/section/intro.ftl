...
<!-- =========================
    INTRO SECTION
============================== -->
<section id="${contentModel['internal-name']}" class="parallax-section intro-section" style="background: url('${contentModel.backgroundImage_s!""}') 50% 0 repeat-y fixed;">
  <div class="container">
    <div class="row">
